...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(Exception exception, Object body, HttpHeaders headers,
        ...
        return ResponseEntity.status(httpStatus)
                .body(Optional.ofNullable(body)
                        .orElse(ExceptionMessage.of(httpStatus, exception.getMessage(),
    ...
    private ResponseEntity<Object> handleException(Exception exception, HttpStatus httpStatus,
        ...
        return handleExceptionInternal(exception, ExceptionMessage.of(httpStatus, message, request.getDescription(false)),
